...
class Cell:
    ...
    def __add__(self, other):
        return (f'Клетки соеденились и получилась одна большая размером: {self.quantity + other.quantity}')

    def __sub__(self, other):
        sub = self.quantity - other.quantity

        if sub > 0:
            return (f'Клетка уменьшилась в размере и стала {sub}')
        else:
            return (f'Клетка изчезла!')

    def __mul__(self, other):
        return (f'Клетки перемножились и теперь она размером {self.quantity * other.quantity}')

    def __truediv__(self, other):
        return (f'Клетки поделились и теперь она размером {self.quantity // other.quantity}')
...
cell = Cell (random.randint(1, 100))
cell_2 = Cell (random.randint(1, 100))
print(cell)
print(cell_2)
print(cell + cell_2)
print(cell - cell_2)
print(cell / cell_2)
print(cell * cell_2)
print(cell.make_order(random.randint(5, 20)))
